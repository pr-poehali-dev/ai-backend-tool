          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-muted-foreground">{(config.creativity !== undefined && config.creativity !== null ? config.creativity : 0.7).toFixed(1)}</span>
              </div>
              <Slider
                value={[Math.round((config.creativity !== undefined && config.creativity !== null ? config.creativity : 0.7) * 10)]}
